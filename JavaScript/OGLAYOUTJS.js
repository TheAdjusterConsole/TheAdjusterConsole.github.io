...
function MENU() {
  ...
  const swapVer = document.getElementById("swapVer");
  ...
  if (menuOpen === 'false') {
    ...
    appearance.style.top = "40px";
    appearance.style.opacity = '1';
    BtnBuilder.style.top = "60px";
    BtnBuilder.style.opacity = '1';
    swapVer.style.top = "80px";
    swapVer.style.opacity = '1';
    ...
    swapVer.style.top = "20px";
    swapVer.style.opacity = '0';
